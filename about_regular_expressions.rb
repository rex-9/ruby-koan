...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/] # TOLEARN:
  end
  ...
  def test_slash_capital_a_anchors_to_the_start_of_the_string
    assert_equal "start", "start end"[/\Astart/]
    assert_equal nil, "start end"[/\Aend/]
  end

  def test_slash_small_z_anchors_to_the_end_of_the_string
  ...
  def test_slash_b_anchors_to_a_word_boundary
    assert_equal "vines", "bovine vines"[/\bvine./] # TOLEARN:
  end
  ...
  def test_sub_is_like_find_and_replace
    assert_equal "one t-three", "one two-three".sub(/(t\w*)/) { $1[0, 1] } # TOLEARN:
  end

  def test_gsub_is_like_find_and_replace_all
    assert_equal "one t-t", "one two-three".gsub(/(t\w*)/) { $1[0, 1] } # TOLEARN:
  end
end
